...
const PrivacyModal = () => {
    ...
    useEffect(() => {
        ...
        const hasAgreed = localStorage.getItem('psitsPrivacyAgreed');
        if (!hasAgreed) {
            setIsOpen(true);
        }
    }, []);
    ...
    const handleAgree = () => {
        localStorage.setItem('psitsPrivacyAgreed', 'true');
        setIsOpen(false);
    };

    const handleDecline = () => {
        // Must close modal to proceed, but since it's required we alert them here.
        alert("You must acknowledge the Privacy Policy to proceed.");
    };
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#0a0608]/80 backdrop-blur-md p-4 antialiased font-['Space_Grotesk',sans-serif]">
            {/* Modal Container: Glassmorphism + Accent Color border */}
            <div className="relative w-full max-w-2xl bg-[#1a2238]/80 border border-[#5671FF]/50 shadow-[0_0_20px_rgba(86,113,255,0.3)] backdrop-blur-xl rounded-xl overflow-hidden max-h-[90vh] flex flex-col">
                ...
                <div className="p-6 md:p-10 overflow-y-auto scrollbar-thin scrollbar-thumb-[#5671FF] scrollbar-track-transparent">
                    ...
                    {/* Featured Image/Graphic Section */}
                    <div className="mb-8 relative rounded-lg overflow-hidden border border-[#5671FF]/20 group">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage:
                                    'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCElGDnG77R5XoH7I3YhOEHe2MtORpXYmFq4IxMwfO2oLVCS0xHRFBAXOFOprThYECBCYvG2Ey6Mia4etRErIFOtvdCYkylimYUMlWozTJlQv0GInURp6zRRA9iKxaa-buWyqXy6COpQajQ_ucGXy8dUcKFrJKGWGUY-eBi4Fwc33Lhv8qlS2HTUMNMOl3redxfFNAce6YaArbf8yYprBeSxt5e-NcKO-N07VHcxJDWzpZn7bOpRS2YChDiiwtTFYV1jCANQwcEi0Sc")',
                            }}
                        ></div>
                        <div className="absolute bottom-4 left-4 z-20">
                            <p className="text-xs uppercase tracking-[0.2em] font-bold text-[#5671FF]">
                    ...
                    <div className="space-y-6">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="flex items-center gap-3 p-3 bg-[#5671FF]/5 border border-[#5671FF]/10 rounded-lg group hover:border-[#5671FF]/40 transition-colors">
                                ...
                                <div className="flex items-center gap-3 p-3 bg-[#5671FF]/5 border border-[#5671FF]/10 rounded-lg group hover:border-[#5671FF]/40 transition-colors md:col-span-2">
                                    <span className="material-symbols-outlined text-[#5671FF] text-xl">
                                        groups_3
                                    </span>
                                    <div>
                    ...
                    <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-[#5671FF]/20">
                        <p className="text-slate-500 text-xs text-center md:text-left">
                            By closing this modal, you acknowledge that you have read and
                            understood our data handling procedures.
                        </p>
                        <div className="flex gap-4 shrink-0">
                            <button
                                onClick={handleAgree}
                                className="px-8 py-2.5 bg-[#FF602D] hover:bg-[#FF602D]/90 text-white rounded-lg font-bold text-sm transition-all shadow-[0_0_15px_rgba(255,96,45,0.4)]"
                            >
                                Accept & Close
                            </button>
                        </div>
