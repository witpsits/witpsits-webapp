  ...
  const handleEditClick = (achievement) => {
    ...
    setNewAchievement({
      ...
      date_achieved: achievement.date_achieved
        ? new Date(achievement.date_achieved).toISOString().split("T")[0]
        : "",
              ...
              <form onSubmit={handleAddAchievement} className="p-6 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    value={
                      ...
                      [
                        ...
                        "Seminars",
                        "Others",
                      ].includes(newAchievement.category)
                        ? newAchievement.category
                        : newAchievement.category
                          ? "custom"
                          : "Others"
                  ...
                  <p className="text-[10px] text-slate-500">
                    Categorize this achievement for better filtering on the
                    showcase page.
                  </p>
                </div>
                <div className="pt-4 border-t border-[#5671FF]/10 flex justify-end gap-3 pb-2">
                  <button
                    type="button"
                    onClick={handleCloseModal}
                    className="px-6 py-2.5 rounded-lg text-sm font-bold text-slate-400 hover:bg-white/5 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-6 py-2.5 rounded-lg text-sm font-bold bg-[#FF602D] text-white hover:bg-[#FF602D]/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
        ...
        <div className="p-4 lg:p-10 flex flex-col flex-1">
          ...
          {loading ? (
            <div className="flex items-center justify-center flex-1">
              <p className="text-[#5671FF] font-bold animate-pulse">
            ...
            <div className="flex items-center justify-center flex-1">
              <div className="text-center">
                ...
                <p className="text-slate-400">
                  Click the 'Add Achievement' button to showcase student and
                  faculty victories.
                </p>
              </div>
            </div>
                          ...
                          <div className="flex items-center gap-3">
                            {item.image_url ? (
                              <img
                                src={item.image_url}
                                alt="Award"
                                className="w-10 h-10 rounded border border-[#5671FF]/30 object-cover"
                              />
                            ) : (
