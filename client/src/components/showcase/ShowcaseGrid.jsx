    ...
    useEffect(() => {
        const fetchAchievements = async () => {
            try {
                ...
                // Add alternating aspect ratios for the masonry-like layout
        ...
        <div className="flex-1">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-[#1a2238] rounded-2xl border border-[#5671FF]/10">
                    ...
                    <h3 className="text-xl font-bold text-slate-300">No achievements recorded yet</h3>
                    ...
                    {achievements.map((item, index) => (
                        <div key={item.id || index} className="relative group break-inside-avoid rounded-2xl overflow-hidden bg-[#1a2238] border border-[#5671FF]/10 hover:border-[#5671FF]/50 transition-all hover:shadow-[0_0_20px_rgba(86,113,255,0.2)]">
                            ...
                            <div className="absolute bottom-0 p-6 w-full">
                                {item.date_achieved && (
                                   <span className="inline-block px-3 py-1 rounded-full bg-[#5671FF]/20 text-[#5671FF] text-[10px] font-bold uppercase tracking-widest mb-3 backdrop-blur-md border border-[#5671FF]/30">
