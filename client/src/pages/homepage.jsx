            ...
            <div className="relative grid items-center gap-8 p-8 md:grid-cols-2 md:p-16">
              <div className="flex flex-col gap-6">
                ...
                <div className="max-w-md group/desc relative">
                  <p
                    className={`text-base leading-relaxed text-slate-400 ${latestEvents[0] ? "line-clamp-3" : ""}`}
                  >
                    {latestEvents[0]?.description ||
                      "Join the PSITS-WIT Chapter. Experience the digital glitch revolution and connect with industry pioneers. Registration is now open for all WIT students."}
                  </p>
                  {latestEvents[0]?.description &&
                    latestEvents[0].description.length > 180 && (
                      <button
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    onClick={() =>
                      latestEvents[0] ? setSelectedEvent(latestEvents[0]) : null
                    }
                ...
                <div className="col-span-full text-center py-16 bg-[#1a2238] rounded-2xl border border-[#5671FF]/10 flex flex-col items-center gap-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold text-slate-300">
                      No transmissions found at the moment
                    </h3>
                    <p className="text-sm text-slate-500 max-w-xs mx-auto">
                      Our systems are currently awaiting new updates. Please
                      check back shortly for the latest department bulletins.
                    </p>
                  </div>
                </div>
              ) : (
                ...
                <div className="flex flex-col h-full gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-slate-400">
                      Curated modules, study groups, and resource sharing to
                      help you excel in your IT curriculum.
                    </p>
                  </div>
                </div>
              </SpotlightCard>
              ...
              <SpotlightCard className="h-full border-[#5671FF]/20 bg-[#5671FF]/5 transition-all">
                <div className="flex flex-col h-full gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-slate-400">
                      Connect with the student council and alumni mentors who
                      are shaping the chapter's future.
                    </p>
                  </div>
                </div>
              </SpotlightCard>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-xl text-center md:text-left">
                ...
                <p className="text-white/80">
                  Follow our official Facebook page today and get the latest
                  updates on upcoming workshops, resources, and networking
                  events.
                </p>
              </div>
          ...
          >
            ...
            <div className="relative w-full md:w-[40%] h-64 md:h-auto overflow-hidden group/modal-img shrink-0 border-r border-white/5">
              ...
              <div className="absolute bottom-8 left-8 hidden md:block">
                <div className="flex flex-col gap-1">
                  <span className="text-[8px] font-black uppercase tracking-[0.3em] text-[#5671FF]">
                    TRANS-ID: WIT-PSITS
                  </span>
                  <span className="text-[10px] text-white/50 font-mono tracking-tighter uppercase">
                    SECURE TRANSMISSION
                  </span>
                </div>
              </div>
              ...
              <div className="p-8 sm:p-12 md:p-14 space-y-10">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <div className="flex items-center gap-2 px-3 py-1 bg-[#5671FF]/10 rounded-full border border-[#5671FF]/20 shadow-[0_0_15px_rgba(86,113,255,0.1)]">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-[0.1em] text-[#5671FF]">
                      ANNOUNCEMENT
                    </span>
                  </div>
                ...
                <div className="prose prose-invert max-w-none">
                  <p className="text-slate-200 leading-[1.9] text-[17px] sm:text-[18px] font-medium whitespace-pre-wrap selection:bg-[#5671FF]/40">
                    {selectedEvent.description ||
                      "System protocols indicate that no detailed description was provided for this transmission node."}
                  </p>
                </div>
